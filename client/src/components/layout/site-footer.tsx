        ...
        <div className="md:flex md:items-center md:justify-between">
          <div className="md:w-1/3 mb-8 md:mb-0">
            <div className="flex items-center mb-4">
              <span className="text-primary font-bold text-2xl">HumanZ</span>
            </div>
            <p className="text-muted-foreground mb-4">
              Unlock your human potential with AI-powered growth tracking and community support.
            </p>
          ...
          <div className="md:w-2/3 grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-sm font-semibold text-foreground tracking-wide uppercase mb-4">Product</h3>
            ...
            <div>
              <h3 className="text-sm font-semibold text-foreground tracking-wide uppercase mb-4">Resources</h3>
              <ul className="space-y-3">
            ...
            <div>
              <h3 className="text-sm font-semibold text-foreground tracking-wide uppercase mb-4">Company</h3>
              <ul className="space-y-3">
            ...
            <div>
              <h3 className="text-sm font-semibold text-foreground tracking-wide uppercase mb-4">Legal</h3>
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-muted-foreground hover:text-primary">Data Policy</a></li>
              </ul>
            </div>
          </div>
        </div>
        
        <div className="mt-8 pt-8 border-t border-border flex flex-col md:flex-row md:items-center md:justify-between">
          <p className="text-muted-foreground text-sm">&copy; {new Date().getFullYear()} HumanZ. All rights reserved.</p>
